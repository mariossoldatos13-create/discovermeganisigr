...
const translations: Translations = {
  ...
  "boats.safetySupport": { en: "In the event of a malfunction or any issue during your trip, simply contact us and our response will be immediate. Whether resolving the problem over the phone or dispatching assistance to your exact location, we ensure rapid support — all our vessels are equipped with GPS tracking for your peace of mind.", el: "Σε περίπτωση βλάβης ή οποιουδήποτε προβλήματος κατά τη διάρκεια της εκδρομής σας, απλά επικοινωνήστε μαζί μας και η ανταπόκρισή μας θα είναι άμεση. Είτε επιλύοντας το πρόβλημα τηλεφωνικά είτε στέλνοντας βοήθεια στην ακριβή σας τοποθεσία, εξασφαλίζουμε ταχεία υποστήριξη — όλα τα σκάφη μας είναι εξοπλισμένα με GPS για τη δική σας ηρεμία." },
