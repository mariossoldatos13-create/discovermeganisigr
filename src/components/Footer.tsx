        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex gap-4">
              ...
              <a
                href="viber://chat?number=+306912345678"
                className="w-10 h-10 rounded-full bg-card/10 hover:bg-accent flex items-center justify-center transition-colors duration-300"
                aria-label="Viber"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="tel:+306912345678" className="font-sans text-card/70 text-sm hover:text-accent transition-colors duration-300">
                  +30 691 234 5678
                </a>
              </div>
              <div className="flex items-center gap-3">
                <Mail className="w-5 h-5 text-accent flex-shrink-0" />
                <a href="mailto:info@meganisirentals.gr" className="font-sans text-card/70 text-sm hover:text-accent transition-colors duration-300">
                  info@meganisirentals.gr
                </a>
              </div>
            </div>
          </div>
